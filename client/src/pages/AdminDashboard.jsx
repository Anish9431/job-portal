        ...
        <div className='min-h-screen bg-gray-50/30'>
            ...
            <nav className='fixed top-0 z-10 w-full flex items-center justify-between px-4 sm:px-12 py-3 bg-white border-b shadow-sm'>
                ...
                <div className='flex items-center gap-3'>
                    <p className='max-sm:hidden font-medium text-gray-600'>Hi! Admin</p>
            ...
            <div className='flex pt-[65px]'>
                ...
                <div className='fixed left-0 top-[65px] bottom-0 w-20 sm:w-64 bg-white border-r min-h-screen transition-all duration-300'>
                    <div className='flex flex-col pt-6'>
                        ...
                        >
                            <img className={`w-5 h-5 transition-transform duration-200 group-hover:scale-110 ${window.location.pathname.includes('manage-users') ? 'brightness-75' : 'opacity-70 group-hover:opacity-100'}`} src={assets.person_icon} alt="" />
                            <p className='max-sm:hidden font-medium'>Manage Users</p>
                        </NavLink>
                        ...
                        >
                            ...
                            <p className='max-sm:hidden font-medium'>Manage All Jobs</p>
                        </NavLink>
